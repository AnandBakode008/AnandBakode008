<h2 align="center">Hi there, I'm Anand Bakode! 👋</h2>

<p align="center">
  <b>Data Analyst → Data Scientist in progress</b><br/>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Power%20BI-Expert-orange?style=flat-square&logo=powerbi" />
...
- 🔭 Currently working as a **Data Analyst Trainee** at Softtronix Software Services, Nagpur
...
- 🎓 B.Tech in CSE from SisTech-E Bhopal
- 💬 Ask me about **SQL, Power BI, Python, EDA, Data Visualisation, Dashboard Creation**, or breaking into Data Science
...
| **Analysis** | Pandas, NumPy, Scikit-Learn, EDA, Statistical Modeling |
| **Visualization** | Power BI, Tableau, Matplotlib, Seaborn |
| **Databases** | MySQL, PostgreSQL, Joins, CTEs, Window Functions |
| **ML & NLP** | Random Forest, XGBoost, NLP Sentiment Analysis |
| **Tools** | Jupyter, VS Code, Git, GitHub, ETL Pipelines |
...
| Metric | Value |
|---|---|
| Stock records processed via ETL | 500K+ |
| ML model accuracy (location predictor) | 80% |
| Manual reporting effort reduced | 70% |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=AnandBakode008&show_icons=true&theme=default&hide_border=true" height="160"/>
